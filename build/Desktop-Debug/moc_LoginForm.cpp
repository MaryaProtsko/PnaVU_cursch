...
Q_CONSTINIT static const qt_meta_stringdata_LoginForm_t qt_meta_stringdata_LoginForm = {
    {
        ...
        QT_MOC_LITERAL(23, 0),  // ""
        QT_MOC_LITERAL(24, 14),  // "toRegisterForm"
        QT_MOC_LITERAL(39, 20),  // "onLoginButtonClicked"
        QT_MOC_LITERAL(60, 23)   // "onRegisterButtonClicked"
    },
    "LoginForm",
    "loginSuccess",
    "",
...
void LoginForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->toRegisterForm(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &LoginForm::loginSuccess; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (LoginForm::*)();
            if (_t _q_method = &LoginForm::toRegisterForm; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
