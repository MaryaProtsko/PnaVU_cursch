    ...
    ui(new Ui::TasksWindow)
{
    ...
    QString taskFile = "C:/ToDo/ToDo/data/" + getDateStr() + ".txt";
    QString doneFile = "C:/ToDo/ToDo/checkBox/" + getDateStr() + ".txt";
    QString tagFile = "C:/ToDo/ToDo/tag/" + getDateStr() + ".txt";
    QFile file(taskFile);
...
void TasksWindow::on_listWidget_clicked(const QModelIndex &index)
{
    ...
    connect(deleteAction, &QAction::triggered, [=]() {
        ...
        msgBox.setIconPixmap(QPixmap("C:/ToDo/ToDo/img.png"));
        ...
        if (reply == QMessageBox::Yes) {
            ...
            deleteLineFromFile("C:/ToDo/ToDo/time/" + getDateStr() + ".txt", index.row());
            deleteLineFromFile("C:/ToDo/ToDo/tag/" + getDateStr() + ".txt", index.row());
...
void TasksWindow::on_comboBoxSort_activated(int index)
{
    ...
    {
        QString time = "C:/ToDo/ToDo/time/" + getDateStr() + ".txt";
        QFile timeFile(time);
        QString tagFile = "C:/ToDo/ToDo/tag/" + getDateStr() + ".txt";
        QFile file(tagFile);
...
void TasksWindow::createEditWindow(int index)
{
    ...
    QString note = "C:/ToDo/ToDo/note/" + getDateStr() + "task" + way + ".txt";
    QFile noteFile(note);
